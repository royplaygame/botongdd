<template xmlns:v-on="http://www.w3.org/1999/xhtml">
    <div class="set" style="height: 100%;">
        <div class="masterTop">
        	<a href="javascript:;" @click='backtrack'><img src="../../../static/img/Shape.png" alt="" /></a>
        ...
        <div class="masterBot">
            <div class="BindingAccount">
            	<ul>
            		...
            		<li id='asterisk'>*</li>
            		<li>：</li>
            		<li id='interval'><input type="text" placeholder='搜索本企业员工姓名或手机号' /></li>
            	</ul>
            </div>
            <div class="telPhone">
            	<ul>
            ...
            <div class="authCode">
            	<ul>
            		...
            		<li id='asterisk'>*</li>
            		<li>：</li>
            		<li id='interval'><input type="text" placeholder='请填写验证码' :class="{borderMa:IsborderMa}" @focus='inputFocus' @blur='inputOut' onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"/>
            ...
            <div class="masterNext"><a href="javascript:;" @click='complete'>完成</a></div>
        </div>
    </div>
</template>
<script>
