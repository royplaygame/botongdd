    ...
    <div class="set">
        <div class="main_rightTop">
            <p>
                ...
                <span style="margin-left: 5px;">新建考勤组</span>
            </p>
        </div>
        <div class="main_rightMain">
            ...
            <div><span style="float: left;">考勤类型：</span>
                <div class="radioGroup">
                    <div class="radio_input">
                        <input type="radio" class="radio_origin" id="fixed" checked='checked' name="paiban" value="fixedpaiban">
                        <label for="fixed" name="fixed" @click="single" class="checked"> 
                                    <div class="radio_inner"></div>
                                    <span class="radio_label">固定班制</span>
                               </label>
                    </div>
                    <div class="radio_input">
                        <input type="radio" class="radio_origin" id="paiban" name="paiban" value="paiban">
                        <label for="paiban" name="paiban" @click="single" style="margin: 0 15px;"> 
                                    <div class="radio_inner"></div>
                                    <span class="radio_label">排班制</span>
                               </label>
                    </div>
                    <div class="radio_input">
                        <input type="radio" class="radio_origin" id="free" name="paiban" value="freepaiban">
                        <label for="free" name="free" @click="single"> 
                                    <div class="radio_inner"></div>
                                    <span class="radio_label">自由排班</span>
                               </label>
                    </div>
                </div>
            </div>
            <!--固定排班-->
            <div class="paibanradio" v-show="guding">
                <div><span style="float: left;">全局时段：</span>
                    <div class="globalTime">
                        <ul style="float: left;">
                            <li v-for="(item,index) in items" style="overflow: hidden;">
                                <div class="DatetimeBox" style="margin-left: 10px;">
                                    <el-time-select :picker-options="{
                                            start: '08:30',step: '00:05',end: '18:30'
                                            }" v-model="starTime[index]" placeholder="任意时间" :editable='false' clearable>
                                        </el-time-select>
                                </div>
                                ...
                                <div class="DatetimeBox">
                                    <el-time-select :picker-options="{
                                            ...
                                            }" v-model="endTime[index]" placeholder="任意时间" :editable='false' clearable>
                                        </el-time-select>
                                </div>
                                <div v-show="index == 0" class="addbox" @click="add()"></div>
                                <div v-show="index != 0" class="removebox" @click="remove(index)"></div>
                            </li>
                        </ul>
                ...
                <div class="dailyHours">
                    <span style="float: left;">每天时段：</span>
                    <div>
                        <div style="float: left;margin-left: 10px;"><span>周一</span><span style="margin-left: 6px;"><span>{{starTime[0]}}</span>-<span>{{endTime[0]}}</span></span>
                        </div>
                        <div class="dailyicon" @click="dailySetclick"></div>
                    </div>
                    <div>
                        <div style="float: left;margin-left: 10px;"><span>周一</span><span style="margin-left: 6px;"><span>{{starTime[0]}}</span>-<span>{{endTime[0]}}</span></span>
                        </div>
                    ...
                    <div style="margin-left: 78px;">
                        <el-checkbox v-model="legal">法定节假日放假</el-checkbox>
                    </div>
                </div>
                <div class="advanceSet">
                    <span style="float: left;">高级设置：</span>
                    <div>
                        <div style="float: left;margin-left: 10px;"><span>5月27日 周六</span><span style="margin-left: 30px;">上班</span></div>
                        <div class="dailyicon" @click="highSet"></div>
                    </div>
                    <div><span style="margin-left: 80px;">6月01日 周一</span><span style="margin-left: 30px;">休息</span></div>
                </div>
                <div class="attendance">
                    ...
                    <div class="locationAtt">
                        ...
                        <ul>
                            <li v-for="(item,index) in locations_1">
                                <span>{{item}}</span>
                    ...
                    <div class="wifiAtt">
                        ...
                        <ul style="overflow: hidden">
                            <li v-for="(item,index) in locations_2">
            ...
            <!--自由班制-->
            <div class="paibanradio" v-show="ziyou">
                <div class="advanceSet">
                    <span style="float: left;">高级设置：</span>
                    <p style="overflow: hidden;padding-left: 10px;"><el-checkbox v-model="ziyouallowField">允许外勤打卡</el-checkbox></p>
                ...
                <div class="attendance">
                    ...
                    <div class="locationAtt">
                        ...
                        <ul>
                            <li v-for="(item,index) in locations_5">
                                <span>{{item}}</span>
                                <div class="deletelocation"></div>
                            </li>
                        </ul>
                    ...
                    <div class="wifiAtt">
                        ...
                        <ul style="overflow: hidden">
                            <li v-for="(item,index) in locations_6">
                                <span>{{item.location}}</span><span>{{item.wifiname}}</span><span>{{item.wifiip}}</span>
                                <div class="deletelocation"></div>
                            </li>
                        </ul>
                ...
                <div class="modalsBot">
                    <div class="chunk">
                        <div class="punch">
                            <span>最早打卡时间</span>
                            <div class="selectBox">
                                <el-select v-model="delay_1" placeholder="请选择">
                                    <el-option v-for="item in delays_1" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                        ...
                        <div class="punch">
                            <span>最晚打卡时间</span>
                            <div class="selectBox">
                                <el-select v-model="delay_2" placeholder="请选择">
                                    <el-option v-for="item in delays_2" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                    ...
                    <div class="chunk">
                        <div class="punch">
                            <span>上班弹性时间</span>
                            <div class="selectBox">
                                <el-select v-model="delay_3" placeholder="请选择">
                                    <el-option v-for="item in delays_3" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                        ...
                        <div class="punch">
                            <span>设置严重迟到</span>
                            <div class="selectBox">
                                <el-select v-model="delay_4" placeholder="请选择">
                                    <el-option v-for="item in delays_4" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                        ...
                        <div class="punch">
                            <span>设置旷工</span>
                            <div class="selectBox">
                                <el-select v-model="delay_5" placeholder="请选择">
                                    <el-option v-for="item in delays_5" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                    ...
                    <div class="chunk">
                        <div class="punch">
                            <el-checkbox v-model="correlation">设置请假、外出、出差、补卡关联</el-checkbox>
                        </div>
                        <div class="punch">
                            <span class="grayfont">关联后系统自动计算出考勤情况，方便统计</span>
                        </div>
                    ...
                    <div class="chunk">
                        <div class="punch">
                            <span>上班打卡提醒</span>
                            <div class="selectBox">
                                <el-select v-model="delay_6" placeholder="请选择">
                                    <el-option v-for="item in delays_6" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                        ...
                        <div class="punch">
                            <span>下班打卡提醒</span>
                            <div class="selectBox">
                                <el-select v-model="delay_7" placeholder="请选择">
                                    <el-option v-for="item in delays_7" :label="item.label" :value="item.value" :key="aa">
                                    </el-option>
                                </el-select>
                            </div>
                        ...
                        <div class="punch">
                            <el-checkbox v-model="allowField">允许外勤打卡</el-checkbox>
                        </div>
                    </div>
                    <div class="chunk" style="margin-bottom: 0;border-bottom: none;">
                        <div class="punch">
                            <span>设置特殊日期</span>
                        </div>
                        <div class="punch">
                        ...
                        <div class="punch">
                            <span>开始日期</span><span style="margin-left: 179px;">结束日期</span>
                        </div>
                        <div class="punch">
                            <div class="datetimeBox">
                                <el-date-picker v-model="StartTime" type="date" placeholder="起始时间" :editable='false' clearable></el-date-picker>
                            </div>
                            <div class="datetimeBox" style="margin-left: 94px;">
                                <el-date-picker v-model="EndTime" type="date" placeholder="结束时间" :editable='false' clearable></el-date-picker>
                            </div>
                        </div>
                        <div class="punch">
                            <span>设置为</span>
                            <div class="radioGroups">
                                <div class="radio_input" style="margin-left: 10px;">
                                    <input type="radio" class="radio_origin" id="work" checked='checked' name="paiban" value="shangban">
                                    <label for="work" name="work" @click="singles" class="checked"> 
                                        <div class="radio_inner"></div>
                                        <span class="radio_label">上班</span>
                                    </label>
                                </div>
                                <div class="radio_input" style="margin-left: 4px;">
                                    <input type="radio" class="radio_origin" id="rest" name="paiban" value="xiuxi">
                                    <label for="rest" name="rest" @click="singles"> 
                                        <div class="radio_inner"></div>
                                        <span class="radio_label">休息</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="punch">
                            <ul style="float: left;">
                                <li v-for="(item,index) in items_1" style="overflow: hidden;">
                                    <div class="DatetimeBox">
                                        <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_1[index]" placeholder="任意时间" :editable='false' clearable>
                                            </el-time-select>
                                    </div>
                                    <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                    <div class="DatetimeBox">
                                        <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_1[index]" placeholder="任意时间" :editable='false' clearable>
                                            </el-time-select>
                                    </div>
                                    <div v-show="index == 0" class="addbox" @click="add_1()"></div>
                                    <div v-show="index != 0" class="removebox" @click="remove_1(index)"></div>
                                </li>
                            </ul>
                        </div>
                        <div class="punch">
                            <div class="addicon"></div> <span class="grayfont" style="margin-left: 5px;float: left;">添加特殊日期</span>
                        </div>
                    </div>
        ...
        <!--每天时段设置弹出框-->
        <div class="ModalsBox" v-show="dailySet">
            <div class="Modals dailySetModal">
                <div class="modalsTop">每天考勤时段设置</div>
                <div class="modalsBot dailySetmodalsBot">
                    <div class="week">
                        <el-checkbox v-model="monday" @change="ischeck_2">周一</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_2">
                                <span>{{starTime_2[0]}} - {{endTime_2[0]}}</span> <span>{{starTime_2[1]}} - {{endTime_2[1]}}</span>                                <span>{{starTime_2[2]}} - {{endTime_2[2]}}</span>
                                <div class="penicon" @click="peniconclick_2"></div>
                            </div>
                            <div v-show="haverest_2">休息</div>
                            <div class="setquantum" v-show="setquantum_2">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_2" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_2[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_2[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_2()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_2(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Tue" @change="ischeck_3">周二</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_3">
                                <span>{{starTime_3[0]}} - {{endTime_3[0]}}</span> <span>{{starTime_3[1]}} - {{endTime_3[1]}}</span>                                <span>{{starTime_3[2]}} - {{endTime_3[2]}}</span>
                                <div class="penicon" @click="peniconclick_3"></div>
                            </div>
                            <div v-show="haverest_3">休息</div>
                            <div class="setquantum" v-show="setquantum_3">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_3" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_3[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_3[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_3()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_3(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Wed" @change="ischeck_4">周三</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_4">
                                <span>{{starTime_4[0]}} - {{endTime_4[0]}}</span> <span>{{starTime_4[1]}} - {{endTime_4[1]}}</span>                                <span>{{starTime_4[2]}} - {{endTime_4[2]}}</span>
                                <div class="penicon" @click="peniconclick_4"></div>
                            </div>
                            <div v-show="haverest_4">休息</div>
                            <div class="setquantum" v-show="setquantum_4">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_4" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_4[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_4[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_4()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_4(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Thu" @change="ischeck_5">周四</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_5">
                                <span>{{starTime_5[0]}} - {{endTime_5[0]}}</span> <span>{{starTime_5[1]}} - {{endTime_5[1]}}</span>                                <span>{{starTime_5[2]}} - {{endTime_5[2]}}</span>
                                <div class="penicon" @click="peniconclick_5"></div>
                            </div>
                            <div v-show="haverest_5">休息</div>
                            <div class="setquantum" v-show="setquantum_5">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_5" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_5[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_5[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_5()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_5(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Fri" @change="ischeck_6">周五</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_6">
                                <span>{{starTime_6[0]}} - {{endTime_6[0]}}</span> <span>{{starTime_6[1]}} - {{endTime_6[1]}}</span>                                <span>{{starTime_6[2]}} - {{endTime_6[2]}}</span>
                                <div class="penicon" @click="peniconclick_6"></div>
                            </div>
                            <div v-show="haverest_6">休息</div>
                            <div class="setquantum" v-show="setquantum_6">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_6" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_6[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_6[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_6()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_6(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Sat" @change="ischeck_7">周六</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_7">
                                <span>{{starTime_7[0]}} - {{endTime_7[0]}}</span> <span>{{starTime_7[1]}} - {{endTime_7[1]}}</span>                                <span>{{starTime_7[2]}} - {{endTime_7[2]}}</span>
                                <div class="penicon" @click="peniconclick_7"></div>
                            </div>
                            <div v-show="haverest_7">休息</div>
                            <div class="setquantum" v-show="setquantum_7">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_7" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_7[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_7[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_7()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_7(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="week">
                        <el-checkbox v-model="Sun" @change="ischeck_8">周日</el-checkbox>
                        <div class="timepart">
                            <div v-show="quantum_8">
                                <span>{{starTime_8[0]}} - {{endTime_8[0]}}</span> <span>{{starTime_8[1]}} - {{endTime_8[1]}}</span>                                <span>{{starTime_8[2]}} - {{endTime_8[2]}}</span>
                                <div class="penicon" @click="peniconclick_8"></div>
                            </div>
                            <div v-show="haverest_8">休息</div>
                            <div class="setquantum" v-show="setquantum_8">
                                <ul style="float: left;">
                                    <li v-for="(item,index) in items_8" style="overflow: hidden;">
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                         start: '08:30',step: '00:05',end: '18:30'
                                        }" v-model="starTime_8[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <span style="float: left;line-height: 32px;margin: 0 5px;">———</span>
                                        <div class="DatetimeBox">
                                            <el-time-select :picker-options="{
                                        start: '08:30',step: '00:05',end: '18:30',minTime:starTime[index]
                                        }" v-model="endTime_8[index]" placeholder="任意时间" :editable='false' clearable>
                                                </el-time-select>
                                        </div>
                                        <div v-show="index == 0" class="addbox" @click="add_8()"></div>
                                        <div v-show="index != 0" class="removebox" @click="remove_8(index)"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="modalfoot" style="padding: 27px;">
                    <input type="button" value="保存" class="baocun" style="margin-right: 24px;">
                    <input type="button" value="取消" class="quxiao" style="margin-left: 24px" @click="dailySetcancle">
                </div>
            </div>
        </div>
        <!--地图-->
    ...
    export default {
        ...
        methods: {
            ...
            single: function (event) {
                ...
                $('.radioGroup label').removeAttr('class') && el.setAttribute("class", "checked")
                $('.radioGroup input[type = "radio"]').removeAttr('checked') && $('#' + radioId).attr('checked', 'checked')
                if($('#fixed').attr('checked')){
                    this.guding = true
                    this.ziyou = false
                    this.paiban = false
                }else if($('#paiban').attr('checked')){
                    this.guding = false
                    this.ziyou = false
                    this.paiban = true
                }else{
