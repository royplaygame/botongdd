    ...
    <div class="set" style="height: 100%;">
        ...
        <div class="main_rightMain">
            <div class="firmname">
                ...
                <input v-model="sendRange" class="inputText" type="text" placeholder="选择部门、人员" @focus="focusInput_1" @blur="blurInput_1"
            ...
            <div class="firmname">
                ...
                <input maxlength="35" v-model="noticeTitle" class="inputText" type="text" placeholder="最多35个汉字" @focus="focusInput_2" @blur="blurInput_2"
            ...
            <div class="firmname">
                ...
                <input maxlength="10" v-model="author" class="inputText" type="text" placeholder="不填则默认为公司名称" @focus="focusInput_3" @blur="blurInput_3"
